        ...
        <div className="w-full max-w-md">
          ...
          <div className="mt-8 space-y-6">
            <button
              ...
              className="w-full flex justify-center items-center gap-2 py-2.5 px-4 border border-border bg-surface rounded-lg text-sm font-medium text-heading hover:bg-gray-50 transition-colors focus:outline-none focus:ring-2 focus:ring-accent"
            >
