      ...
      <div className="w-full max-w-sm space-y-8">
        ...
        <div className="mt-8 space-y-6">
          <button
            ...
            className="w-full flex justify-center items-center gap-2 py-2.5 px-4 border border-zinc-800 rounded-lg text-sm font-medium hover:bg-zinc-900 transition-colors focus:outline-none focus:ring-2 focus:ring-zinc-700"
          >
