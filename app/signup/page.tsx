      ...
      <div className="w-full max-w-md px-4">
        <div className="bg-surface border border-border rounded-none p-8 md:p-10 space-y-8 shadow-xs">
          <div className="text-left space-y-3">
            ...
            <div>
              <h2 className="text-3xl font-heading font-bold text-heading tracking-tight">Create an account</h2>
              <p className="text-sm font-sans text-muted mt-1">Join the developer publication & network</p>
            </div>
          </div>
